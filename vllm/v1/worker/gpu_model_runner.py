...
from vllm.v1.attention.backends.mod_attn import ModAttnAttentionMetadataBuilder
    ...
    def _build_attention_metadata(
        ...
        def _build_attn_group_metadata(
            ...
            if use_spec_decode and isinstance(
                ...
                if isinstance(builder, ModAttnAttentionMetadataBuilder):
        ...
        for group in self._kv_cache_spec_attn_group_iterator():
            ...
            for layer_name in group.layer_names:
                ...
                if isinstance(kv_cache_spec, AttentionSpec) and not isinstance(
                    kv_cache_spec, SlidingWindowModAttnSpec
                ):
                    has_attn = True
                ...
                elif isinstance(kv_cache_spec, (MambaSpec, SlidingWindowModAttnSpec)):
                    has_mamba = True
                    raw_tensor = kv_cache_raw_tensors[layer_name]
                    state_tensors = []
