...
spec_manager_map: dict[type[KVCacheSpec], type[SingleTypeKVCacheManager]] = {
    ...
    SlidingWindowModAttnSpec: SlidingWindowManager,
...
spec_uniform_base_map: dict[type[KVCacheSpec], type[KVCacheSpec]] = {
    ...
    SlidingWindowModAttnSpec: SlidingWindowModAttnSpec,
...
class TestKVCacheSpecRegistry:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (SlidingWindowModAttnSpec, "sliding_window", 256),
            (SlidingWindowModAttnSpec, "component_dims", (32, 64, 256)),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (SlidingWindowModAttnSpec, SlidingWindowMLASpec),
            (SlidingWindowModAttnSpec, SlidingWindowSpec),
